        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="relative">
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-6 -left-6 bg-gold text-white rounded-2xl px-6 py-4 shadow-xl">
                <p className="text-2xl font-bold font-lobster">12+</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {categories.map((cat, i) => (
              <Link
                key={cat.slug}
                href={`/shop/${cat.slug}`}
                className="group relative aspect-[3/4] rounded-2xl overflow-hidden bg-gradient-to-br from-gray-200 to-gray-100 card-hover img-zoom"
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 z-20">
                  ...
                  <span className="inline-block mt-3 text-gold text-xs uppercase tracking-wider font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    Explore →
                  </span>
                </div>
              </Link>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={item.title}
                className="group text-center p-8 rounded-2xl border border-gray-100 card-hover hover:border-gold/30 bg-white"
              >
                <span className="text-5xl block mb-6 transition-transform duration-300 group-hover:scale-110">
                  {item.icon}
                </span>
